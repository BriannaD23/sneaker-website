document.addEventListener('DOMContentLoaded', function () {
    ...
    // Add an event listener to the cart icon to show the dropdown
    cartIcon.addEventListener('click', showCartDropdown);
    ...
    function handleAddToCartClick(event) {
        ...
        // Show the dropdown after adding an item to the cart
        showCartDropdown();
    }
    ...
    function updateCartTotal() {
        ...
        if (hasItems) {
            ...
            showCartDropdown(); // Explicitly show the dropdown when there are items
            cartItemCount.style.display = 'inline-block';
        } else {
